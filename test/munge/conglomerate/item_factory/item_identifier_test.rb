...
class ConglomerateItemFactoryItemIdentifierTest < TestCase
  test "removes specified extensions from basename" do
    identifier = Munge::Conglomerate::ItemFactory::ItemIdentifier.new(remove_extensions: dynamic_extensions)
  ...
  test "removes all extensions" do
    identifier = Munge::Conglomerate::ItemFactory::ItemIdentifier.new(remove_extensions: remove_all_extensions)
